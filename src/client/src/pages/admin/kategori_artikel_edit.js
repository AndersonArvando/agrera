...
function AdminKategoriArtikelEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`/admin/category/article/edit/${id}`, {
                method: 'POST',
                ...
                <div className="mb-3">
                    <div className="mb-4">
                        <span className="fs-4 " style={{
                            color: '#028430',
                            fontWeight: 'bold',
                        }}>Ubah Kategori Artikel</span>
                    </div>
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            <label className="form-label">Nama Kategori Artikel</label>
                            <input onChange={handleChange} value={formData.name} required name="name"  type="text" className="form-control" style={{ borderColor: '#028430', boxShadow: 'none', }} placeholder="Kategori Artikel" />
                        </div>
                        <div className="mb-3 text-end">
                            <Link to={'/admin/kategori/artikel'}>
...
export default AdminKategoriArtikelEdit;
