...
function AdminKursus() {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete) {
            try {
                const response = await fetch(`/admin/course/delete/${id}`, {
                    method: "POST",
                });
                ...
                fetchData();
                NotificationManager.success('Kursus berhasil dihapus!', 'Berhasil');
            } catch (err) {
                ...
                <div className="row align-items-center mb-3">
                    <div className="col-lg-3 col-md-6 mb-3">
                        <div className="input-group">
                            ...
                            <input type="text" className="form-control search-artikel" style={{ borderRadius: '50rem', borderTopLeftRadius: '0', borderBottomLeftRadius: '0', borderColor: '#028430', boxShadow: 'none', borderLeft: '0', paddingLeft: '0' }} placeholder="Cari Kursus..." />
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 mb-3">
                        <div className="input-group">
                        ...
                        <tbody>
                            {
                                data.length > 0 ? data.map((item, index) => (
                                    <tr>
                                        ...
                                        <td style={{ wordBreak: 'break-all' }}>{item.youtube_url}</td>
                                        <td style={{ wordBreak: 'break-all' }}>{item.canva_url}</td>
                                        <td>{item.category_name }</td>
                                        <td>
                                            <Link to={"/admin/kursus/edit/" + item.id}>
                                    ...
                                    <tr>
                                        <td colspan="7" align="center" style={{ color: 'grey' }}>Tidak ada data di tabel ini</td>
                                    </tr>
                            }
                        </tbody>
                    </table>
