            ...
            <div style={{ paddingLeft: '30px' }} className="col">
                ...
                <div className="mb-3">
                    <div className="mb-4">
                        ...
                        }}>Kursus Tersimpan</span>
                    </div>
                    {data.length > 0 && data.map((item, index) => (
                        <div className="d-flex flex-wrap align-items-center rounded-4 overflow-hidden mb-3" style={{ backgroundColor: '#EBF6EF' }}>
                            ...
                            <div className="col-lg-8 col-md-6 p-3">
                                <div className="d-flex flex-wrap flex-column justify-content-between h-100">
                                    <div>
                                        <h4 className="fw-bold color-primary">
                                        {item.name}
                                        </h4>
                                        <p style={{
                                            fontSize: 14,
                                    ...
                                    <div className="d-flex flex-wrap justify-content-between align-items-end">
                                        <div className="px-3 py-1 rounded-5 color-primary fw-bold" style={{ fontSize: 14, backgroundColor: 'white', border: '1px solid #028430', width: 'fit-content' }}>{item.category_name}</div>
                                        <div className="col-12 col-lg text-end">
                                            <button className="btn text-white rounded-5 col-lg-4 col-md-5 col-sm-6 col-12 my-2 fw-bold mx-2" style={{backgroundColor: '#CF2B27', fontSize: 20,}}>Hapus</button>
                                            <Link to={"/user/kursus/detail/" + item.id}>
                                                <button className="btn rounded-5 col-lg-4 col-md-5 col-sm-6 col-12 my-2 fw-bold mx-2" style={{backgroundColor: '#028440', fontSize: 20, color: '#FFDA3A'}}>Buka</button>
                                            </Link>
                                        </div>
                                    </div>
...
export default KursusTersimpan;
