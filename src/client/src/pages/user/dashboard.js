            ...
            <div style={{ paddingLeft: '30px' }} className="col">
                ...
                <div className="mb-3">
                    ...
                    <div className="rounded-3" style={{
                        backgroundImage: "url(" + require("../../image/user_dashboard_bg.png") + ")",
                        backgroundPosition: 'center',
                        backgroundSize: 'auto',
                        backgroundRepeat: 'no-repeat',
                    }}>
                        <div className="p-3 text-center">
                            <img src={require('../../image/logo_white.png')} style={{ width: 250 }} className="mb-3" alt="Logo" /> {/* Replace with your logo */}
                            <h4 className="px-lg-5 text-white">Pertanian bukan hanya pekerjaan, tetapi panggilan untuk merawat dan melindungi tanah yang memberi kita kehidupan.</h4>
                            <h4 className="px-lg-5 text-white">" Wendell Berry”</h4>
                        </div>
                    </div>
                </div>
                <div className="mb-3">
